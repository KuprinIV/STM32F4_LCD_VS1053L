...
public:
    ...
    typedef touchgfx::meta::TypeList< main_screenView,
            touchgfx::meta::TypeList< codecTestScreenView,
            touchgfx::meta::TypeList< testFatFS_screenView,
            touchgfx::meta::TypeList< playAudioFileView,
            touchgfx::meta::TypeList< soundRecordView,
            touchgfx::meta::TypeList< oscilloscopeView,
            touchgfx::meta::TypeList< externalStimulatorView,
            touchgfx::meta::Nil > > > > > >
            > GeneratedViewTypes;
    ...
    typedef touchgfx::meta::TypeList< main_screenPresenter,
            touchgfx::meta::TypeList< codecTestScreenPresenter,
            touchgfx::meta::TypeList< testFatFS_screenPresenter,
            touchgfx::meta::TypeList< playAudioFilePresenter,
            touchgfx::meta::TypeList< soundRecordPresenter,
            touchgfx::meta::TypeList< oscilloscopePresenter,
            touchgfx::meta::TypeList< externalStimulatorPresenter,
            touchgfx::meta::Nil > > > > > >
